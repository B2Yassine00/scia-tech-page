...
export const about = {
  big_title: "About Us",
  description:
    "At SciaTech, we're on a mission to redefine the way sciatica pain is managed. We commit  to providing individuals suffering from sciatica discomfort with smart solutions that not only offer relief but also empower them to take charge of their health journey.",
};
