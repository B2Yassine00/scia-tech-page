      ...
      >
        <div className="grid lg:grid-cols-2 lg:overflow-visible">
          <div className="lg:w-[130%] text-center lg:text-left">
            <h1 className="text-[3rem] md:text-[4rem] pr-4 leading-tight font-extrabold text-[#142F48]">
              {home.first_text}
            </h1>
            <h3 className="mt-4 text-[1.5rem] font-bold text-[#142F48]">
              {home.second_text}
            </h3>
            <h3 className=" text-[1.5rem] font-bold text-[#142F48]">
              {home.third_text}
            </h3>
            <div className="flex justify-center lg:block">
              <a href="#steps">
                <br />
                <button className="bg-[#05668D] border-4 border-transparent hover:border-[#05668D] hover:bg-white hover:text-[#05668D] mt-2 items-center flex gap-5 text-white font-semibold text-2xl pl-10 py-2 pr-5 rounded-[150px] text-center hover:svg-fill-[#05668D] transition-all ease-out duration-300">
                  Get Started
                  <svg
                    width="40"
                    height="41"
          ...
          <img
            src={foot}
            alt="foot"
            className="hidden lg:flex mt-[-10rem] w-full"
          />
        </div>
      </div>
