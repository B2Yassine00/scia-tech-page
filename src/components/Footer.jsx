    ...
    return (
        <div>
            ...
            <div className="container pt-9">
                ...
                <a href="https://www.instagram.com/rabiialaoui10/" target="_blank" className="mr-9 text-neutral-800 dark:text-neutral-200 text-white">
                    <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-4 w-4"
                    fill="currentColor"
                ...
                <a href="https://www.linkedin.com/in/rabii-alaoui-754460200/" target="_blank" className="text-neutral-800 dark:text-neutral-200 text-white">
                    <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-4 w-4"
                    fill="currentColor"
